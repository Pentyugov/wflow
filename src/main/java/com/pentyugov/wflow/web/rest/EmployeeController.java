...
public class EmployeeController extends AbstractController {
    ...
    public ResponseEntity<Object> getEmployeeById(@PathVariable String id, Principal principal) throws EmployeeNotFoundException, UserNotFoundException {
    ...
    public ResponseEntity<Object> addNewEmployee(@RequestBody EmployeeDto employeeDto, Principal principal) throws UserNotFoundException,
    ...
    public ResponseEntity<Object> updateEmployee(@RequestBody EmployeeDto employeeDto, Principal principal) throws UserNotFoundException,
                                                                                              EmployeeExistException,
    ...
    @PutMapping("/update-all-employees")
    public ResponseEntity<Object> updateAllEmployees(@RequestBody List<EmployeeDto> employees) throws PositionNotFoundException, UserNotFoundException, DepartmentNotFoundException {
